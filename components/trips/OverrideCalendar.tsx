          ...
          return (
            <button
              ...
              className={cn(
                ...
                isToday && 'ring-2 ring-[#c1272d] ring-offset-1',
                override === 'SKIP' ? 'bg-[#E24B4A]/10 text-[#E24B4A]' :
                override === 'ADD' ? 'bg-[#0F6E56]/10 text-[#0F6E56]' :
                isScheduledDay && !isPast ? 'bg-[#c1272d]/10 text-[#0F1923]' :
            ...
            >
              ...
              {isScheduledDay && !override && (
                <span className="absolute bottom-0.5 w-1 h-1 rounded-full bg-[#c1272d]" />
              )}
            </button>
          )
        })}
