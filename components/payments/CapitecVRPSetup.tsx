...
export function CapitecVRPSetup() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start gap-3 bg-[#c1272d]/04 rounded-xl p-3">
        <Smartphone className="w-5 h-5 text-[#c1272d] mt-0.5 shrink-0" />
      ...
      {countdown > 0 ? (
        <div className="text-center py-4">
          <p className="text-3xl font-bold text-[#c1272d] tabular-nums">
        ...
        <>
          ...
          <Button
            ...
            className="w-full h-12 bg-[#c1272d] text-white font-semibold rounded-xl"
          >
