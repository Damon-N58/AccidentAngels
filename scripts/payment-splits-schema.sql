...
CREATE TABLE IF NOT EXISTS "SplitParty" (
  "id"                     TEXT PRIMARY KEY,
  "key"                    TEXT UNIQUE NOT NULL,            -- machine slug, e.g. 'insurance'
  "label"                  TEXT NOT NULL,                   -- human name, e.g. 'Insurance'
  "kind"                   "SplitPartyKind" NOT NULL DEFAULT 'FIXED',
  "paystackSubAccountCode" TEXT,                            -- null → settles to main account
...
CREATE TABLE IF NOT EXISTS "SplitScheme" (
  ...
  "gatewayPercentBps" INTEGER NOT NULL DEFAULT 150,          -- 150 bps = 1.5%
  "gatewayFlatCents"  INTEGER NOT NULL DEFAULT 200,          -- R2.00
  "notes"             TEXT,
...
CREATE TABLE IF NOT EXISTS "TransactionSplit" (
  ...
  "schemeId"               TEXT,
  "partyId"                TEXT,
  "partyKey"               TEXT NOT NULL,        -- denormalised for stable history
  "partyLabel"             TEXT NOT NULL,
  "partyKind"              "SplitPartyKind" NOT NULL,
  "calcType"               "SplitCalcType" NOT NULL,
  "resolvedSubAccountCode" TEXT,                 -- subaccount money actually routed to (if any)
...
-- Pulls existing PLATFORM_FEE_CENTS / TCC_SPLIT_CENTS from PlatformConfig so
-- the first live charge after migration splits identically to before.
-- ============================================================================

INSERT INTO "SplitParty" ("id", "key", "label", "kind", "sortOrder") VALUES
  ('splitparty_driver',      'driver',         'Driver',                 'DRIVER',      100),
  ('splitparty_association', 'association',    'Association',            'ASSOCIATION',  10),
  ('splitparty_platform',    'nineteen58',     'Nineteen58 (Platform)',  'FIXED',        20),
  ('splitparty_tcc',         'accident_angels','Accident Angels',        'FIXED',        30),
  ('splitparty_insurance',   'insurance',      'Insurance',              'FIXED',        40)
ON CONFLICT ("key") DO NOTHING;

INSERT INTO "SplitScheme" ("id", "name", "isActive", "activatedAt", "notes") VALUES
  ('splitscheme_default', 'Default scheme', TRUE, now(),
...
INSERT INTO "SplitShare" ("id", "schemeId", "partyId", "calcType", "value", "sortOrder") VALUES
  ('splitshare_association', 'splitscheme_default', 'splitparty_association', 'ASSOCIATION_LEVY', 0, 10)
...
INSERT INTO "SplitShare" ("id", "schemeId", "partyId", "calcType", "value", "sortOrder") VALUES
  ('splitshare_insurance', 'splitscheme_default', 'splitparty_insurance', 'FLAT', 0, 40)
ON CONFLICT ("schemeId", "partyId") DO NOTHING;

-- Driver → REMAINDER (everything left after gateway fee + all cuts above)
INSERT INTO "SplitShare" ("id", "schemeId", "partyId", "calcType", "value", "sortOrder") VALUES
  ('splitshare_driver', 'splitscheme_default', 'splitparty_driver', 'REMAINDER', 0, 100)
ON CONFLICT ("schemeId", "partyId") DO NOTHING;
